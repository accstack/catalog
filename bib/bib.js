...
const AUDIT_LABEL={'well-sourced':'Well sourced','adequate':'Adequate','thin':'Thin','at-risk':'At risk','no-stress-source-exists':'No stress source exists','—':'Not audited (no stress record yet)'};
...
const WORLD_LABEL={'—':'Stress already recorded (not part of the reading pass)'};
...
function renderRail(){ const rail=$('rail'); const keep=rail.scrollTop; rail.innerHTML='';
  ...
  mk('Reading pass, languages without a stress record','worldk','world',WORLD_ORDER,WORLD_LABEL);
