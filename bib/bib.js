...
const ACCESS={digital:{label:'Digital',cls:'a-digital',long:'an open copy, a copy on file, or a copy behind a university library login'},scan_deliver:{label:'Scan & Deliver',cls:'a-scan',long:'a research library we checked holds a print copy: articles and chapters can be scanned on request, whole books are a loan'},print_only:{label:'Print only',cls:'a-print',long:'located (a print copy, or a publisher record behind a paywall), but no open copy and not held by the libraries we checked'},unknown:{label:'Unknown',cls:'a-unknown',long:'not located, or not yet checked'}};
