...
const ORIGIN_LABEL={glottolog:'from Glottolog',reader:'added by the compilers',scan:'added by the compilers',database:'cited in the catalog entry',jsweep:'found by the journal search',"journal-universe":'found by the journal search',"journal-universe-major":'found by the journal search',"language-search":'found by the per-language search'};
